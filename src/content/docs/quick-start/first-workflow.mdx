...
![Import a workflow template](/src/assets/tutorial/import-first-workflow.png)

After importing, click **Create job** in the top-right.

![Create a job](/src/assets/tutorial/first-create-job.png)

On the job creation page, click **Enqueue now** at the bottom.

![Enqueue now](/src/assets/tutorial/first-enqueue.png)

This creates a run. You’ll typically see a **Run status** card showing whether the run is in progress or finished.

![Run status](/src/assets/tutorial/first-run.png)
...
![Run details](/src/assets/tutorial/run-result.png)
...
![Create a workflow step](/src/assets/tutorial/create-workflow-step.png)

#### Edit the code

![Edit a step](/src/assets/tutorial/edit-step.png)
